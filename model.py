...
popchurn =popchurn_df[['NET_BAD_DEBT', 'BAD_DEBT_FLAG', 'NOD', 'NO OF INVOICES GENERATED','CHURN']]
...
#saving the model
pickle.dump(model, open('model_popchurn_new.pkl', 'wb'))
